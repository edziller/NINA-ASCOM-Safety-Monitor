...
namespace ASCOM.EZZillerSafetyMonitor
{
    public class SafetyMonitorHardware
    {
        ...
        public float LimiteDeltaP { get; set; } = -3.0f;
        public float LimiteUmidade { get; set; } = 75.0f;
        public int TimeoutNublado { get; set; } = 10;
        
        // tendências: "-1=Queda,0=Estável,1=Aumento"
        ...
        public void InitialiseHardware()
        {
            ...
            // Altitude
            string altStr = profile.GetValue("ASCOM.EZZillerSafetyMonitor.SafetyMonitor", "Altitude", "1000");
        ...
        public void EnviarTimeoutNublado()
        {
            port.WriteLine($"TIMEOUT_NUBLADO:{TimeoutNublado.ToString(CultureInfo.InvariantCulture)}");
        }
    }
}